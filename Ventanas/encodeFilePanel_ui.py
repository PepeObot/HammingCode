...
class Ui_encodeFile(object):
    def setupUi(self, encodeFile):
        ...
        self.protegerFile1024_btn = QPushButton(encodeFile)
        self.protegerFile1024_btn.setObjectName(u"protegerFile1024_btn")
        self.protegerFile1024_btn.setGeometry(QRect(490, 630, 291, 51))
        font3 = QFont()
        font3.setPointSize(12)
        font3.setBold(True)
        self.protegerFile1024_btn.setFont(font3)
        ...
        self.protegerFile8_btn = QPushButton(encodeFile)
        self.protegerFile8_btn.setObjectName(u"protegerFile8_btn")
        self.protegerFile8_btn.setGeometry(QRect(90, 630, 291, 51))
        self.protegerFile8_btn.setFont(font3)
        self.protegerFile16384_btn = QPushButton(encodeFile)
        self.protegerFile16384_btn.setObjectName(u"protegerFile16384_btn")
        self.protegerFile16384_btn.setGeometry(QRect(890, 630, 291, 51))
        self.protegerFile16384_btn.setFont(font3)
    ...
    def retranslateUi(self, encodeFile):
        ...
        self.protegerFile1024_btn.setText(QCoreApplication.translate("encodeFile", u"Proteger Archivo (Bloque 1024)", None))
        self.selectLabel_2.setText(QCoreApplication.translate("encodeFile", u"Archivo Seleccionado:", None))
        self.protegerFile8_btn.setText(QCoreApplication.translate("encodeFile", u"Proteger Archivo (Bloque 8)", None))
        self.protegerFile16384_btn.setText(QCoreApplication.translate("encodeFile", u"Proteger Archivo (Bloque 16384)", None))
    # retranslateUi
