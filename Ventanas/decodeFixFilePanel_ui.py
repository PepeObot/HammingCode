...
class Ui_decodeFixFile(object):
    ...
    def retranslateUi(self, decodeFixFile):
        ...
        self.label_2.setText(QCoreApplication.translate("decodeFixFile", u"Archivo Protegido:", None))
        self.label_3.setText(QCoreApplication.translate("decodeFixFile", u"Archivo Desprotegido:", None))
    # retranslateUi
